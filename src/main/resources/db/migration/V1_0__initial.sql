...
ALTER TABLE restaurant_number
    ADD CONSTRAINT FK_RESTAURANT_NUMBER_ON_ADDRESS FOREIGN KEY (address_id) REFERENCES address (id);
...
ALTER TABLE restaurant_number_assignment
    ADD CONSTRAINT FK_ASSIGNMENT_ON_RESTAURANT_NUMBER FOREIGN KEY (restaurant_number_id) REFERENCES restaurant_number (id);

CREATE INDEX IDX_ASSIGNMENT_RESTAURANT_NUMBER_ID ON restaurant_number_assignment (restaurant_number_id);

ALTER TABLE restaurant_number_assignment
    ADD CONSTRAINT FK_ASSIGNMENT_ON_LICENSE_HOLDER FOREIGN KEY (license_holder_id) REFERENCES license_holder (id);
